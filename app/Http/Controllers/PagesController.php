...
class PagesController extends Controller
{
    ...
    public function registeruser()
    {
        ...
        return view('pages.registeruser', compact('page_title'));
    }
    // KTDatatables
    ...
    {
        $page_title = 'Test';
        $page_description = 'This is test page';

        return view('layout.login', compact('page_title', 'page_description'));
    }
    ...
    public function edit()
    {
        ...
        ->first();
        return view('admin.users.editProfile')->with([
            'user' => $user,
        ]);
    }

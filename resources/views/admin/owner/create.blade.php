...
<div class="d-flex flex-column-fluid">
	...
	<div class="container">
		...
		<div class="card card-custom gutter-b">
			...
			<div class="card-body p-0">
				<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
					<div class="col-xl-12 col-xxl-12">
						<!--begin::Wizard Form-->
						<form class="form" method="post" id="kt_form" action="/storeowner" enctype="multipart/form-data">
                        @csrf
            ...
            <div class="col-lg-4">
            <label>Flat No.</label>
            <input id="flat_no" type="text" class="form-control  " name="flat_no" required autocomplete="flat_no" autofocus/>
            </div>
            <div class="col-lg-4">
		...
		<!--begin::Wizard Step 3-->
		 <div class="my-5 step" data-wizard-type="step-content">
			<h5 class="mb-10 font-weight-bold text-dark">Room Details</h5>
				...
				<div class="col-lg-4">
					...
					<span class="option-control">
						<span class="radio radio-bold radio-brand">
							<input type="radio" id="m_option_1" name="m_option_1" value="{{ $offer->id }}" />
							<span></span>
						</span>
					</span>
					<span class="option-label">
						<span class="option-head">
							<span class="option-title">{{ $offer->of_type }} {{ $offer->pck_id }}</span>
							<span class="option-focus">Rs. {{ $offer->amount }}</span>
						</span>
						<span class="option-body">No of Parking: {{ $offer->no_of_jobs }}</span>
						<span class="option-body">No of Inventory: {{ $offer->no_of_ivnt }}</span>
						<span class="option-body">No of Housing Service: {{ $offer->no_of_agent }}</span>
                        <span class="option-body">Floor: {{ $offer->floor }}</span>
						<span class="option-body">Block: {{ $offer->block }}</span>
					</span>
					</label>
					@error('m_option_1')
								    <span class="invalid-feedback" role="alert">

...
<html lang="en">
				 ...
				 <div class="col-lg-3 mb-lg-0 mb-6">
					...
					<div class="col-lg-3 mb-lg-0 mb-6">
                        <div class="form-group" id="filter_col0" data-column="2">
                            ...
                            <input type="text" name="Flat No" class="form-control column_filter" id="col2_filter" placeholder="Contact Number">
                        </div>
                    </div>
				 <!--phone-->
					<div class="col-lg-3 mb-lg-0 mb-6">
                        <div class="form-group" id="filter_col0" data-column="3">
                            ...
                            <input type="phone" name="Vehicle No." class="form-control column_filter" id="col3_filter" placeholder="Flat Number">
                        </div>
                    </div>
            </div>
  ...
  @if($FetchPostID->id==$user->society_id)
  <tr>
	  ...
	  <td>{{ $user->citizen_type }}</td>
	  <td>
	  @if( $user->is_active==1)
		<span class="label label-lg font-weight-bold label-light-success label-inline">Resident</span>
		@else
		<span class="label label-lg font-weight-bold label-light-danger label-inline">Ex-Resident</span>
		@endif
		</td>
	  <td>

		<a href="#" data-toggle="tooltip" title="Only for admins" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2">
		<i class="far fa-edit text-primary"></i></a>
		@if( $user->is_active==1)
		<a href="{{ route('owner.users.changestatus', $user->id )}}" type="submit" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Delete">								

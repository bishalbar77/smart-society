							...
							<div class="container">
								...
								<div class="card-header flex-wrap py-5">
										<div class="card-title">
											...
											<div class="text-muted pt-2 font-size-sm">All available roles are listed below</div></h3>
										</div>
		...
		<div class="card-body">
            <form id="clear">
				...
				<button class="btn btn-secondary btn-secondary--icon" onclick="ClearFields();">
					...
					@if ($role->id == 1 && Auth::user()->user_id!='')
						@continue
					@endif
                        <tr>
							...
							<td>
                                ...
                                @can('role_delete')
                                    <form action="{{ route('roles.destroy', $role->id) }}" method="POST" onsubmit="return confirm('Confirm delete');" style="display: inline-block;">
                                        <input type="hidden" name="_method" value="DELETE">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <input type="submit" class="btn btn-xs btn-danger" value="D">
                                    </form>
                                @endcan

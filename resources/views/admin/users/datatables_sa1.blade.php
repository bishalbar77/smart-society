...
<html lang="en">
							...
							<div class="container">
								...
								<div class="card-header flex-wrap py-5">
										<div class="card-title">
											<h3 class="card-label">Society Access Management
											<div class="text-muted pt-2 font-size-sm">All these users have society access</div></h3>
										</div>
									</div>
									<div class="card-body">
										<!--begin: Datatable-->
				 ...
				 <div class="col-lg-3 mb-lg-0 mb-6">
					...
					<div class="col-lg-3 mb-lg-0 mb-6">
                        <div class="form-group" id="filter_col0" data-column="2">
                            <label>Contact</label>
                            <input type="text" name="Flat No" class="form-control column_filter" id="col2_filter" placeholder="Contact">
                        </div>
                    </div>
				 <!--phone-->
					<div class="col-lg-3 mb-lg-0 mb-6">
                        <div class="form-group" id="filter_col0" data-column="3">
                            <label>Role</label>
                            <input type="phone" name="Vehicle No." class="form-control column_filter" id="col3_filter" placeholder="Role">
                        </div>
                    </div>
            </div>
  ...
  @if($user->type=='Society Users' && Auth::user()->society_id == $posts->id)
  <tr>

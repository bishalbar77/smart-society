...
<html lang="en">
							...
							<div class="container">
								...
								<div class="card-header flex-wrap py-5">
										<div class="card-title">
											<h3 class="card-label">Society Staff Management
											<div class="text-muted pt-2 font-size-sm">All staffs are listed below</div></h3>
										</div>
									</div>
									<div class="card-body">
										<!--begin: Datatable-->
				 ...
				 <div class="col-lg-3 mb-lg-0 mb-6">
					...
					<div class="col-lg-3 mb-lg-0 mb-6">
                        <div class="form-group" id="filter_col0" data-column="2">
                            ...
                            <input type="text" name="Flat No" class="form-control column_filter" id="col2_filter" placeholder="Phone Number">
                        </div>
                    </div>
				 <!--phone-->
					<div class="col-lg-3 mb-lg-0 mb-6">
                        <div class="form-group" id="filter_col0" data-column="4">
                            ...
                            <input type="phone" name="Vehicle No." class="form-control column_filter" id="col4_filter" placeholder="Department">
                        </div>
                    </div>
            </div>
  ...
  @if($user->type=='Society Staffs' && Auth::user()->society_id == $posts->id)
  <tr>
	  ...
	  <td>
	  @if( $user->is_active==1)
		<span class="label label-lg font-weight-bold label-light-success label-inline">Access Granted</span>
		@else
		<span class="label label-lg font-weight-bold label-light-danger label-inline">Access denied</span>
		@endif
		</td>
	  <td>
		...
		<a href="{{ route('admin.users.edit', $user->id )}}" data-toggle="tooltip" title="Only for admins" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2">
		<i class="far fa-edit text-primary"></i></a>
		@if( $user->is_active==1)
		<a href="{{ route('admin.users.changestatus', $user->id )}}" type="submit" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Delete">								
		<i class="fas fa-trash text-danger"></i></a>
		@else
		<a href="{{ route('admin.users.changestatus', $user->id )}}" type="submit" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Delete">								
		<i class="fa fa-universal-access text-success"></i></a>
		@endif

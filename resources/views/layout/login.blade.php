...
<html lang="en">
	...
	<head><base href="../../../../">
		...
		<link href="css/pages/login/classic/login-5.css?v=7.0.3" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
						...
						<div class="login-signin">
							...
							<form class="form" id="kt_login_signin_form">
								...
								<div class="form-group text-center mt-10">
									<button type="button" class="btn btn-pill btn-primary opacity-90 px-15 py-3">Sign In</button>
								</div>
							</form>
		...
		<script src="js/pages/custom/login/login-general.js?v=7.0.3"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
...
<html lang="en">
	...
	<body  id="kt_body" {{ Metronic::printAttrs('body') }} {{ Metronic::printClasses('body') }}>
											...
											<ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
												...
												<li class="nav-item mr-3">
													<a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_2">
														...
														<span class="nav-text font-size-lg">General Settings</span>
													</a>
												</li>
												<!--end::Item-->
												<!--begin::Item-->
												<li class="nav-item">
													<a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_4">
														...
														<span class="nav-text font-size-lg">Modules Settings</span>
													</a>
												</li>
												<!--end::Item-->
											</ul>
											...
											<div class="tab-content">
													...
													<div class="row">
														...
														<div class="col-xl-7 my-2">
															...
															<div class="form-group row">
																...
																<div class="col-9">
																	<input class="form-control form-control-lg form-control-solid" type="text" name="ltname" value="{{ Auth::user()->ltname}}" />
																</div>
															</div>
															<!--end::Group-->
															<!--begin::Group-->
															...
															<div class="form-group row">
																...
																<div class="col-9">
																	<input class="form-control form-control-lg form-control-solid" type="date" name="dob" value="{{ Auth::user()->dob}}"/>
																	</div>
															</div>
															<!--end::Group-->
															<div class="form-group row">
																...
																<div class="col-9">
																	<input class="form-control form-control-lg form-control-solid" type="text" name="add" value="{{ Auth::user()->add}}"/>
																	</div>
															</div>
															<div class="form-group row">
																<label class="col-form-label col-3 text-lg-right text-left">Pincode</label>
																<div class="col-9">
																	<input class="form-control form-control-lg form-control-solid" type="text" name="pincode" value="{{ Auth::user()->pincode}}"/>
																	</div>
															</div>
															<!--end::Group-->
														...
														<div class="col-xl-7">
															<div class="my-2">
																...
																<div class="row">
																	...
																	<div class="col-9">
																		<h6 class="text-dark font-weight-bold mb-10">General Settings:</h6>
																	</div>
																</div>
																<!--end::Row-->
																<!--begin::Group-->
																<form class="form" method="post" action="/setup/store" enctype="multipart/form-data">
																@csrf
																<div class="form-group row">
																	<label class="col-form-label col-3 text-lg-right text-left">Data Storage Limit</label>
																	<div class="col-9">
																	<div class="input-group input-group-lg input-group-solid">
																	<select class="form-control form-control-lg form-control-solid" name="data" > 
																		<option value="5">5GB - Free Plan</option>
																		<option value="5">10GB - Premium Plan</option>
																		<option value="5">30GB - Business Plan</option>
																		</select>
																		</div>
																	</div>
																</div>
																...
																<!--begin::Group-->
																<div class="form-group row">
																	<label class="col-form-label col-3 text-lg-right text-left">Login Access Limit</label>
																	<div class="col-9">
																		<div class="input-group input-group-lg input-group-solid">
																		<select class="form-control form-control-lg form-control-solid" name="users"> 
																		<option value="5">5 Users - Free Plan</option>
																		<option value="10">10 Users - Premium Plan</option>
																		<option value="30">30 Users - Business Plan</option>
																		</select>
																			</div>
																	</div>
																</div>
																<div class="form-group row">
																	<label class="col-form-label col-3 text-lg-right text-left">Subdomain Name</label>
																	<div class="col-9">
																		<div class="spinner spinner-sm spinner-success spinner-right spinner-input">
																				<input class="form-control form-control-lg form-control-solid" type="text" name="subdomain" value="{{ $posts->subdomain ?? '' }}"/>
																			</div>
																...
																<!--end::Group-->
																<div class="form-group row">
																<label class="col-form-label col-3 text-lg-right text-left">Society Name</label>
																<div class="col-9">
																	<div class="input-group input-group-lg input-group-solid">
																		<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Society Name" name="company"  value="{{ $posts->company ?? '' }}"/>
																	</div>
																</div>
															</div>
																<!--begin::Group-->
																<div class="form-group row">
																	...
																	<div class="col-9">
																		<select class="form-control form-control-lg form-control-solid" name="lang">
																...
																<div class="form-group row">
																	...
																	<div class="col-9">
																		<select class="form-control form-control-lg form-control-solid" name="time">
																...
																<div class="form-group row align-items-center">
																	...
																	<div class="col-9">
																		<div class="checkbox-inline">
																			...
																			<span></span></label>
																			<label class="checkbox">
																			<input type="checkbox" checked="checked" />SMS
																			<span></span></label>
																			<label class="checkbox">
												...
												<div class="tab-pane px-7" id="kt_user_edit_tab_4" role="tabpanel">
														...
														<div class="col-xl-8">
															<div class="my-2">
																...
																<div class="form-group row mb-2">
																	<label class="col-form-label col-3 text-lg-right text-left">Email Notification to Members</label>
																	<div class="col-3">
																		<span class="switch">
																			<label>
																...
																<div class="form-group row">
																	<label class="col-form-label col-3 text-lg-right text-left">Custom Modification</label>
																	<div class="col-3">
																		<span class="switch">
																			<label>
															...
															<div class="row">
																<label class="col-form-label col-3 text-lg-right text-left"></label>
																<div class="col-9">
																	<h6 class="text-dark font-weight-bold mb-7">General Access</h6>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-xl-8">
															<div class="form-group row">
																<label class="col-form-label col-3 text-lg-right text-left">Security Access</label>
																<div class="col-9">
																	<div class="checkbox-single mb-2">
																		<label class="checkbox">
																		<input type="checkbox"  value="1" name="role"/>Custom role service
																		<span></span></label>
																	</div>
																	<div class="checkbox-single mb-2">
																		<label class="checkbox">
																		<input type="checkbox"  value="1" name="cron"/>Custom cron jobs
																		<span class="checkbox-primary"></span></label>
																	</div>
																	<div class="checkbox-single mb-2">
																		<label class="checkbox">
															...
															<div class="form-group row">
																<label class="col-form-label col-3 text-lg-right text-left">Module Access</label>
																<div class="col-9">
																	<div class="checkbox-single mb-2">
																		<label class="checkbox checkbox-success">
																		<input type="checkbox"  value="1" name="personal"/>Personalized domain
																		<span></span></label>
																	</div>
																	<div class="checkbox-single mb-2">
																		<label class="checkbox checkbox-success">
																		<input type="checkbox"  value="1" name="multi" />Multi-vendor sccess
																		<span class="checkbox-primary"></span></label>
																	</div>
																	<div class="checkbox-single mb-2">
																		<label class="checkbox checkbox-success">
																		<input type="checkbox" value="1" name="login"/>Owner-Tenant login access
																		<span></span></label>
																	</div>
																</div>
															</div>
														...
														<div class="col-xl-8">
															...
															<div class="form-group row">
																...
																<div class="col-9">
																	<div class="checkbox-single mb-2">
																		<label class="checkbox checkbox-success">
																		<input type="checkbox" />News about  feature updates
																		<span></span></label>
																	</div>
																	<div class="checkbox-single mb-2">
																		<label class="checkbox checkbox-success">
																		<input type="checkbox" />Tips on getting custom features
																		<span class="checkbox-primary"></span></label>
																	</div>
																	<div class="checkbox-single mb-2">
																		<label class="checkbox checkbox-success">
																		<input type="checkbox" checked="checked" />Log activities of all users
																		<span></span></label>
																	</div>
																	<div class="checkbox-single mb-2">
																		<label class="checkbox checkbox-success">
																		<input type="checkbox" checked="checked" />Recover data
																		<span></span></label>
																	</div>
																	<div class="checkbox-single mb-2">
																		<label class="checkbox checkbox-success">
																		<input type="checkbox" checked="checked" />Custom Template designs
																		<span></span></label>
																	</div>
																</div>
															</div>
																...
																<div class="row">
																	...
																	<div class="col-xl-7">
																		<div class="row">
																			<div class="col-3"></div>
																			<div class="col-9">
																				<a type="submit" class="btn btn-light-primary font-weight-bold">Save changes</a>
																				<a href="/" class="btn btn-clean font-weight-bold">Cancel</a>
																			</div>
																		</div>
																	</div>
		...
		<script src="assets/js/pages/custom/user/edit-user.js?v=7.0.3"></script>
		<!--end::Page Scripts-->

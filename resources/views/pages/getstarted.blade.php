            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="fname" id="name" type="text" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Society Legal Name'" placeholder='Society Legal Name'>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="email1" id="email" type="email" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Society Email address'" placeholder='Society Email address'>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="phone1" id="phone1" type="text" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Society Contact Number'" placeholder='Society Contact Number'>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="state1" id="state1" type="text" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Enter your State'" placeholder='Enter your State'>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="pincode1" id="pincode1" type="text" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Enter Society Pincode'" placeholder='Enter Society Pincode'>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">

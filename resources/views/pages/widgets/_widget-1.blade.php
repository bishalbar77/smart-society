            ...
            <div class="dropdown dropdown-inline">
                ...
                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi navi-hover">
                        ...
                        <li class="navi-item">
                            <a href="/managercreate" class="navi-link">
                                <i class="navi-icon flaticon2-graph-1"></i>
                                <span class="navi-text">Users</span>
                            </a>
                        </li>
                        <li class="navi-item">
                            <a href="/ticket" class="navi-link">
                                <i class="navi-icon flaticon2-calendar-4"></i>
                                <span class="navi-text">Grievance</span>
                            </a>
                        </li>
                        <li class="navi-item">
                            <a href="/audit" class="navi-link">
                                <i class="navi-icon flaticon2-layers-1"></i>
                                <span class="navi-text">Report</span>
                            </a>
                        </li>
                        <li class="navi-item">
                            <a href="/visitor" class="navi-link">
                                <i class="navi-icon flaticon2-calendar-4"></i>
                                <span class="navi-text">Visitor</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="card-spacer mt-n25">
            ...
            <div class="row m-0">
                <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                    ...
                    <a href="/ticket" class="text-warning font-weight-bold font-size-h6">
                        Grievance
                    </a>
                </div>
                <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                    {{ Metronic::getSVG("media/svg/icons/Communication/Add-user.svg", "svg-icon-3x svg-icon-primary d-block my-2") }}
                    <a href="/admin/society/users" class="text-primary font-weight-bold font-size-h6 mt-2">
                        New Users
                    </a>
                </div>
            </div>
            ...
            <div class="row m-0">
                <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                    ...
                    <a href="/visitor" class="text-danger font-weight-bold font-size-h6 mt-2">
                    Visitor
                    </a>
                </div>
                <div class="col bg-light-success px-6 py-8 rounded-xl">
                    {{ Metronic::getSVG("media/svg/icons/Communication/Urgent-mail.svg", "svg-icon-3x svg-icon-success d-block my-2") }}
                    <a href="/audit" class="text-success font-weight-bold font-size-h6 mt-2">
                        Audit Reports
                    </a>
                </div>
            </div>

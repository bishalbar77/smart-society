...
<html lang="en">
							...
							<div class="container">
								...
								<div class="card-header flex-wrap py-5">
										<div class="card-title">
											<h3 class="card-label">Annual Audit Report
										</div>
										<div>
				 ...
				 <div class="col-lg-3 mb-lg-0 mb-6">
					...
					<div class="col-lg-3 mb-lg-0 mb-6">
                        <div class="form-group" id="filter_col0" data-column="3">
                            ...
                            <input type="text" name="Flat No" class="form-control column_filter" id="col3_filter" placeholder="Remittance">
                        </div>
                    </div>
				 <!--phone-->
					<div class="col-lg-3 mb-lg-0 mb-6">
                        <div class="form-group" id="filter_col0" data-column="4">
                            <label>Amount</label>
                            <input type="phone" name="Vehicle Number" class="form-control column_filter" id="col4_filter" placeholder="Amount">
                        </div>
                    </div>
            </div>
  ...
  <tr>
	  ...
	  @if($rent->type =='Credit')
	  <td><span class="label label-lg font-weight-bold label-light-success label-inline">{{ $rent->type }}</span></td>
	  @else
	  <td><span class="label label-lg font-weight-bold label-light-danger label-inline">{{ $rent->type }}</span></td>
	  @endif
	  @if($rent->type =='Credit')
	  <td>{{ $n = $n + $rent->txt_amount }}</td>
	  @else
	  <td>{{ $n = $n - $rent->txt_amount }}</td>
	  @endif
	</tr>

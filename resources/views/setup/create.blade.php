...
<input type="text" class="form-control  form-control-solid @error('name') is-invalid @enderror" id="name" name="name" placeholder="Name" />
@error('name')
...
<select class="form-control form-control-solid  @error('ddl_payment') is-invalid @enderror" id="kt_select2_4" name="issue">
...
<div class="col-lg-4">
<label>Subject</label>
<input type="text" class="form-control form-control-solid"  name="subject" id="subject"/>		
</div>
</div>
</div>
<!--end::Wizard Step 4-->
